...
export default class PasteButton extends Phaser.GameObjects.Container {
  /**
  ...
  constructor(scene, options) {
    ...
    this.hitZone.on(Phaser.Input.Events.POINTER_DOWN, () => { this.pasteAction(); });
  ...
  async pasteAction() {
    if (navigator.clipboard) {
      try {
        ...
        this.actionFn(pasteText);
      } catch (ex) {
        // console.error('navigator.clipboard.readText exception: ', ex);
      }
    }
  }
